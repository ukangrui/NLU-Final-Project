...
class MSMRec(torch.nn.Module):
    ...
    def log2feats(self, log_seqs): 
        ...
        user_logits = self.get_user_logits(log_seqs) # 256 x 3
        user_logits_expanded = user_logits.unsqueeze(1).unsqueeze(-1)  # Shape: [256, 1, 3, 1]
        meta_mix_emb = (meta_emb * user_logits_expanded).sum(dim=2)  # Shape: [256, 200, 50]
